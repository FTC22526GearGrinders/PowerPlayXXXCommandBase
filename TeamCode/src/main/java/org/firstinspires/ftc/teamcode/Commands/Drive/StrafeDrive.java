...
public class StrafeDrive extends CommandBase {
    ...
    public StrafeDrive(Drive_Subsystem drive, double distance) {
        this.drive = drive;
    ...
    public void execute() {
        ...
        drive.drive.driveRobotCentric(temp1, 0, ((startingAngle + drive.getGyroHeading().getDegrees()) * Constants.DriveConstants.MOVE_STRAIGHT_Kp), false);
